...
function generateValidationReportHTML(metrics) {
  return `
    ...
    <div class="metric">
      <span>Top-10 Overlap Accuracy:</span>
      <span class="metric-value">${metrics.topTenOverlapAccuracy}%</span>
    </div>
    <div class="metric">
      <span>Top-20 Overlap Accuracy:</span>
      <span class="metric-value">${metrics.topTwentyOverlapAccuracy}%</span>
    </div>
    <div class="summary">
