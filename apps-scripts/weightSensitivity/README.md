...
node core/adaptiveOptimizer_v2.js --event [event id] --season [season] --tournament "[tournament name]" --dryRun
```
...
OPT_SEED=[seed] node core/adaptiveOptimizer_v2.js --event [event id] --season [season] --tournament "[tournament name]" --dryRun
```
...
OPT_TESTS=[tests] OPT_SEED=[seed] node core/adaptiveOptimizer_v2.js --event [event id] --season [season] --tournament "[tournament name]" --dryRun > output/[tournament]_seed-[seed]_run.log 2>&1 &
```
...
for seed in [seed1] [seed2] [seed3]; do OPT_TESTS=[tests] OPT_SEED=$seed node core/adaptiveOptimizer_v2.js --event [event id] --season [season] --tournament "[tournament name]" --dryRun > output/[tournament]_seed-${seed}_run.log 2>&1 & done
```
...
- **Run the 5‑seed, 10,000‑test batch:**
	- `for seed in a b c d e; do OPT_TESTS=[tests] OPT_SEED=[seed] node core/adaptiveOptimizer_v2.js --event [event id] --season [season] --tournament "[tournament name]" --dryRun > output/[tournament]_seed-[seed]_run.log 2>&1; done` — sequentially run five seeds in one session.
...
- `OPT_TESTS=[tests] OPT_SEED=[seed1] node core/adaptiveOptimizer_v2.js --event [event id] --season [season] --tournament "[tournament name]" --dryRun --log > output/[tournament]_seed-[seed1]_run.log 2>&1 &` — run seed 1 in background and log output.
- `OPT_TESTS=[tests] OPT_SEED=[seed2] node core/adaptiveOptimizer_v2.js --event [event id] --season [season] --tournament "[tournament name]" --dryRun --log > output/[tournament]_seed-[seed2]_run.log 2>&1 &` — run seed 2 in background and log output.
- `OPT_TESTS=[tests] OPT_SEED=[seed3] node core/adaptiveOptimizer_v2.js --event [event id] --season [season] --tournament "[tournament name]" --dryRun --log > output/[tournament]_seed-[seed3]_run.log 2>&1 &` — run seed 3 in background and log output.
...
- `OPT_TESTS=[tests] OPT_SEED=[winning-seed] node core/adaptiveOptimizer_v2.js --event [event id] --season [season] --tournament "[tournament name]" --dryRun --writeTemplates` — generate dry-run template outputs.

5) Write back (only after verifying dry-run outputs):

- `OPT_TESTS=[tests] OPT_SEED=[winning-seed] node core/adaptiveOptimizer_v2.js --event [event id] --season [season] --tournament "[tournament name]" --writeTemplates` — write the templates to the loaders.
